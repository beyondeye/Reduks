...
import com.beyondeye.reduks.AsyncStoreWithStateFlow
 ...
 */
class AsyncStoreWithStateFlowWithStateFlowMiddlewareTest {
    ...
    fun actions_should_be_run_through_a_stores_middleware() {
        ...
        val store = AsyncStoreWithStateFlow(TestState(), reducer, GlobalScope,subscribeContext()) //false: otherwise exception if not running on android
