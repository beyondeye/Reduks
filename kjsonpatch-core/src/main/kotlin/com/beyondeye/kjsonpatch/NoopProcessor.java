...
public class NoopProcessor implements JsonPatchProcessor {
    ...
    @Override public void replace(List<String> path, JsonElement value) {}
    @Override public void add(List<String> path, JsonElement value) {}
    ...
    @Override public void test(List<String> path, JsonElement value) {}
