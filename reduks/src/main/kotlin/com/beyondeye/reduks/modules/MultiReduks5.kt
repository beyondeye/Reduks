...
class MultiReduks5<S1:Any,S2:Any,S3:Any,S4:Any,S5:Any>(ctx1: ReduksContext, def1: IReduksModuleDef<S1>,
                                                       ...
                                                       ctx5: ReduksContext, def5: IReduksModuleDef<S5>) : MultiReduks(), Reduks<MultiState5<S1, S2, S3, S4, S5>> {
