...
class MultiReduks5<S1:Any,S2:Any,S3:Any,S4:Any,S5:Any>(def1: ReduksModuleDef<S1>, ctx1: ReduksContext,
                                         ...
                                         def5: ReduksModuleDef<S5>, ctx5: ReduksContext) : MultiReduks(), Reduks<MultiState5<S1, S2, S3, S4, S5>> {
