...
class MultiReduks4<S1:Any,S2:Any,S3:Any,S4:Any>(ctx1: ReduksContext, def1: IReduksModuleDef<S1>,
                                                ctx2: ReduksContext, def2: IReduksModuleDef<S2>,
                                                ctx3: ReduksContext, def3: IReduksModuleDef<S3>,
                                                ctx4: ReduksContext, def4: IReduksModuleDef<S4>) : MultiReduks(), Reduks<MultiState4<S1, S2, S3, S4>> {
