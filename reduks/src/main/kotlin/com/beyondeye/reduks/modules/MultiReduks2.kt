...
class MultiReduks2<S1:Any,S2:Any>(def1:ReduksModule.Def<S1>,ctx1:ReduksContext,
                                  def2:ReduksModule.Def<S2>,ctx2:ReduksContext) : MultiReduks(),Reduks<MultiState2<S1,S2>>{
