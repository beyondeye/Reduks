...
class MultiReduks3<S1:Any,S2:Any,S3:Any>(def1: ReduksModule.Def<S1>,
                                         def2: ReduksModule.Def<S2>,
                                         def3: ReduksModule.Def<S3>) : MultiReduks(), Reduks<MultiState3<S1, S2, S3>> {
