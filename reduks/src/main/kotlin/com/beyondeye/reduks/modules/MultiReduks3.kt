...
class MultiReduks3<S1:Any,S2:Any,S3:Any>(def1: ReduksModuleDef<S1>, ctx1: ReduksContext,
                                         def2: ReduksModuleDef<S2>, ctx2: ReduksContext,
                                         def3: ReduksModuleDef<S3>, ctx3: ReduksContext) : MultiReduks(), Reduks<MultiState3<S1, S2, S3>> {
