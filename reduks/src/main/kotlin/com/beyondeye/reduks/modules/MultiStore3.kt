...
class MultiStore3<S1 : Any, S2 : Any, S3 : Any>(
    ...
    override fun replaceReducer(reducer: IReducer<MultiState3<S1, S2, S3>>) {
    ...
    class Factory<S1 : Any, S2 : Any, S3 : Any>(@JvmField val storeCreator: StoreCreator<Any>,
        ...
        override fun create(reducer: IReducer<MultiState3<S1, S2, S3>>,
        ...
        override val storeStandardMiddlewares: Array<out IMiddleware<MultiState3<S1, S2, S3>>> =
    ...
    override fun subscribe(storeSubscriber: IStoreSubscriber<MultiState3<S1, S2, S3>>): IStoreSubscription {
