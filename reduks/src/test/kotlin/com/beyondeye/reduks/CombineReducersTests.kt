...
class CombineReducersTests {
    ...
    fun test_CombineTwoReducerWithPlusOperator() {
        ...
        Assertions.assertThat(store.state.reduceActionList).isEqualTo("r1a1 r2a1 ")
        store.dispatch(Action2())
        Assertions.assertThat(store.state.reduceActionList).isEqualTo("r1a1 r2a1 r1a2 r2a2 ")
    }
    @Test
    fun test_CombineThreeReducerWithPlusOperator() {
        ...
        store.dispatch(Action1())
        Assertions.assertThat(store.state.reduceActionList).isEqualTo("r1a1 r2a1 r3a1 ")
        store.dispatch(Action2())
        Assertions.assertThat(store.state.reduceActionList).isEqualTo("r1a1 r2a1 r3a1 r1a2 r2a2 r3a2 ")
    }
    @Test
